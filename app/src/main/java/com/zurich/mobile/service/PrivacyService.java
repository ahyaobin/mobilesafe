package com.ahyaobin.mobile.service;
...
import com.ahyaobin.mobile.activity.EnterPwdActivity;
import com.ahyaobin.mobile.db.Dao.AppLockDao;
...
public class PrivacyService extends Service {
    ...
    public void onCreate() {
        ...
        filter.addAction("com.ahyaobin.mobile.stopprotect");
        registerReceiver(receiver, filter);
        dao = new AppLockDao(this);
        protectedPacknames = dao.findAll();
        //注册一个内容观察者
        Uri uri = Uri.parse("content://com.ahyaobin.mobile/applockdb");
