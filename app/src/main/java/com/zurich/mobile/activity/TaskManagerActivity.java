...
import com.ahyaobin.mobile.adapter.itemfactory.TaskManagerItemFactory;
import com.ahyaobin.mobile.adapter.itemfactory.TaskManagerTitleFactory;
import com.ahyaobin.mobile.adapter.assemblyadapter.AssemblyRecyclerAdapter;
import com.ahyaobin.mobile.engine.TaskInfoProvider;
import com.ahyaobin.mobile.model.TaskInfo;
import com.ahyaobin.mobile.utils.GlobalUtils;
import com.ahyaobin.mobile.utils.SharedPreferenceUtil;
import com.ahyaobin.mobile.utils.SystemInfoUtils;
    ...
    private void initData() {
        ...
        new AsyncTask<Void, Void, Boolean>() {
            ...
            protected Boolean doInBackground(Void... params) {
                ...
                return taskInfos != null && taskInfos.size() > 0;
            }
