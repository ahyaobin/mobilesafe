...
import com.ahyaobin.mobile.Account;
import com.ahyaobin.mobile.R;
import com.ahyaobin.mobile.net.MySingleton;
import com.ahyaobin.mobile.receiver.DownloadCompleteReceiver;
import com.ahyaobin.mobile.service.AddressService;
import com.ahyaobin.mobile.service.CallSmsSafeService;
import com.ahyaobin.mobile.service.PrivacyService;
import com.ahyaobin.mobile.utils.GlobalUtils;
import com.ahyaobin.mobile.utils.PackageInfoUtil;
import com.ahyaobin.mobile.utils.ServiceStatusUtils;
import com.ahyaobin.mobile.utils.SharedPreferenceUtil;
import com.ahyaobin.mobile.view.kbv.KenBurnsView;
...
public class SplashActivity extends FragmentActivity {
    ...
    private void checkApplockService() {
        ...
        if (isOpenPrivacy) {
            ...
            if (!ServiceStatusUtils.isServiceRunning(this, "com.ahyaobin.service.PrivacyService")) {
                startService(intent);
            }
        }
    }
    ...
    private void checkCallSmsService() {
        ...
        if (isOpenIntercept) {
            ...
            if (!ServiceStatusUtils.isServiceRunning(this, "com.ahyaobin.service.CallSmsSafeService")) {
                startService(callSmsSafeIntent);
            }
        }
        if (isAddressOpen) {
            Intent addressIntent = new Intent(this, AddressService.class);
            if (!ServiceStatusUtils.isServiceRunning(this, "com.ahyaobin.service.AddressService")) {
